        ...
        <Grid container spacing={gridSpacing}>
          <Grid item lg={3} sm={6} xs={12}>
            <ReportCard
              ...
              secondary={loggedUser.user_name === 'master' ? 'Total Contributions' : 'Contributed By Me'}
              color={theme.palette.warning.main}
              footerData={loggedUser.user_name === 'master' ? 'Total Pool Amount' : 'My Contributions'}
          ...
          <Grid item lg={3} sm={6} xs={12}>
            <ReportCard
              ...
              secondary={loggedUser.user_name === 'master' ? 'Transcations' : 'Contributed for Me'}
            ...
            <ReportCard
              primary={
                loggedUser.user_name === 'master'
                  ...
                  : (parseFloat(loggedUser?.my_earnings * ethPrice) * 1.04).toFixed(2) + ' $'
              }
              secondary={loggedUser.user_name === 'master' ? 'Potential Interest' : 'Interest'}
              color={theme.palette.error.main}
              footerData={loggedUser.user_name === 'master' ? 'Expected Earnings' : 'My Earnings'}
                ...
                <Grid container spacing={gridSpacing}>
                  <Grid item xs={12}>
                    <SalesLineCard
                      ...
                      footerData={[
                        {
                          value: '$' + (ethPriceArr[6] / 1000000000).toFixed(2) + ' B',
                          label: 'Market Cap '
                        },
                        {
                          value: '$' + (ethPriceArr[7] / 1000000000).toFixed(2) + ' B',
                          label: 'Volume (24h)'
                        }
                      ]}
                    />
